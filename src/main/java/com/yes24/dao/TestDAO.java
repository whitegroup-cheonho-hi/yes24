...
import com.yes24.controller.testController;
...
public class TestDAO {
	...
	public int endShowing() {
		...
		return sqlSession.update("test.endShowing");
	...
	public List<ShowingVO> getEndshowingSq() {
		...
		return sqlSession.selectList("test.getEndShowingSq");
	}
	...
	public int endTicket(int no) {
		...
		return sqlSession.update("test.endTicket", no);
	}
