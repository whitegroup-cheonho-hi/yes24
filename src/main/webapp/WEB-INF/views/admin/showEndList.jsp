...
.listItemTxt button {     cursor: pointer;margin: auto; width: 70px; height: 35px; font-size: 14px; font-weight: bold; background-color: #196ab3; 
...
<body>
	...
	<section>
		<div id="ySContent">
			<div class="titletxt">
				<h3>
					<em><strong class="admimTit">종료공연</strong></em>
				</h3>
			</div>
			<div id="show">
				...
				<div class="listItem">
					<c:forEach var="showList" items="${showList}">
						...
						<div class="listItemdiv">
							<a
								href="${pageContext.request.contextPath}/show/showModifyForm/${showList}">
								<img class="listItemImg"
								src="${pageContext.request.contextPath}/upload/${showList.subImage}">
							</a>
				...
				<ul id="pageInfo" class="pageInfo">
					...
					<c:if test="${pageMake.prev}">
						<li class="pageInfo_btn previous"><a
							href="${pageMake.startPage-1}">◀</a></li>
					</c:if>
					<!-- 각 번호 페이지 버튼 -->
					...
					<c:if test="${pageMake.next}">
						<li class="pageInfo_btn next"><a
							href="${(pageMake.endPage + 1)}">▶</a></li>
					</c:if>
				</ul>

				<div class="clear"></div>
			</div>
			<form action="showEndList" id="moveForm" method="get">
		...
		$
				.ajax({
					...
					success : function(result) {
						// 성공적으로 처리된 경우 리다이렉트
						window.location.href = "${pageContext.request.contextPath}/admin/showEndList/";
					},
