		...
		<div id="ContentsArea" class="container" style="display: block;">
			...
			<div id="step01">
				...
				<div id="step01_date" class="step01_date" style="display: block;">
					...
					<div class="fantxt" style="display: none;">
						<span>본 상품은 <br> ACE 회원 코드 구매 상품입니다. <br>날짜/회차
							정보는 <br>ACE 회원과 무관한 정보이니,<br> 구매 시 참고 바랍니다
						</span>
					</div>
					<div id="calendar" class="calendar">
						<p class="fr">
							<img id="imgTodaySale"
								src="http://tkfile.yes24.com/img/perfsale/btn_day_reserv.gif"
								alt="당일예매" style="display: none;">
						</p>
			...
			<div class="btn">
				<div id="StepCtrlBtnPanel" class="tc">
					<div id="StepCtrlBtn01" style="display: block;">
						<a id="next" href="#none"class="dcursor">다음</a>
					</div>
