...
<link rel="stylesheet" href="${pageContext.request.contextPath }/assets/css/usermodify.css" type="text/css">
...
<style>
section {width: 1000px;margin: 0 auto;padding-top: 70px;height: 1200px;}
#g{border:none;}
