...
<body>
	...
	<div class="wrapper">
		<section class="center slider">
			<div>
				<img src="${pageContext.request.contextPath }/assets/images/그날들카테고리.jpg">
			</div>
			<div>
				<img src="${pageContext.request.contextPath }/assets/images/드림하이카테고리.jpg">
			</div>
			<div>
				<img src="${pageContext.request.contextPath }/assets/images/루치아카테고리.jpg">
			</div>
			<div>
				<img src="${pageContext.request.contextPath }/assets/images/맘마미아카테고리.jpg">
			</div>
			<div>
				<img src="${pageContext.request.contextPath }/assets/images/아르토고흐카테고리.jpg">
			</div>
			<div>
				<img src="${pageContext.request.contextPath }/assets/images/오페라이유령카테고리.jpg">
			</div>
			<div>
				<img src="${pageContext.request.contextPath }/assets/images/쿠로이카테고리.jpg">
			</div>
			<div>
				<img src="${pageContext.request.contextPath }/assets/images/맘마미아카테고리.jpg">
			</div>
